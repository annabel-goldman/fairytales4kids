...
from config import AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, S3_BUCKET_NAME, validate_config
...
def main():
    ...
    if os.path.exists(sitemap_path):
        if upload_file_to_s3(s3_client, sitemap_path, S3_BUCKET_NAME, 'sitemap.xml'):
    ...
    upload_directory_to_s3(s3_client, src_directory, S3_BUCKET_NAME)
